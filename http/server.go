...
func (s *HTTPServer)StartServer() error{
	...
	router.Path("/books/title/{title}").Methods("GET").HandlerFunc(s.httpHandlers.HandleGetBook)
	router.Path("/books/author/{author}").Methods("GET").HandlerFunc(s.httpHandlers.HandleGetAuthorsBooks)
